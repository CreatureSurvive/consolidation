...
- (id)initWithStyle:(NSInteger)style {
    if (self = [super init]) {
        ...
        circleLayer.strokeColor = [[CSCProvider sharedProvider] colorForKey:style ? @"pullToClearColor" : @"ncPullToClearColor"].CGColor;
        circleLayer.fillColor = [UIColor clearColor].CGColor;
        circleLayer.lineWidth = 1.0;
        [self.layer addSublayer:circleLayer];

        xLayer = [CAShapeLayer layer];
        xLayer.strokeColor = [[CSCProvider sharedProvider] colorForKey:style ? @"pullToClearColor" : @"ncPullToClearColor"].CGColor;
...
- (void)layoutSubviews {
    ...
    circleLayer.strokeColor = [[CSCProvider sharedProvider] colorForKey:_style ? @"pullToClearColor" : @"ncPullToClearColor"].CGColor;
    xLayer.strokeColor = [[CSCProvider sharedProvider] colorForKey:_style ? @"pullToClearColor" : @"ncPullToClearColor"].CGColor;
